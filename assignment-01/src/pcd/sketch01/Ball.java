...
public class Ball {
    ...
    private static double FRICTION_FACTOR = 0.25; 	/* 0 minimum */ //è la frizione, l'attrito!! se fosse 0, non ci sarebbe attrito
     ...
     * 
     * se la pallina esce da una parte, viene invertita la velocità per fare in modo che
     * rimbalzi
     * 
     * @param ctx
     */
