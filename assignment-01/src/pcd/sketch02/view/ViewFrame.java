...
/*
in java, possiamo intercettare la pressione/rilascio di un pulsante con un listener
chiamato keylistener.

ViewFrame è il frame che vediamo e a riga 31 vediamo addKeyListener, che vuol dire che 
vogliamo ascoltare la pressione dei pulsanti su questo componente.
Quando implementiamo un keylistener, abbiamo la possibilità di percepire gli eventi come
keyTyped, keyReleased o KeyPressed (vedi per esempio riga 71)
